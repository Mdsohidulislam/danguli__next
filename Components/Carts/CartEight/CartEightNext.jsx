...
const CartEightNext = ({infos,count, setOfferProduct}) => { 
    ...
    const handleAddToCart = () => { 
        ...
        // let promotion__name = infosArray[0];
        // let product__ides = infos._id; 
        // axios.post(serverPort+'/api/promotion/post__single', {user__key, promotion__name, product__ides}).then(res => {
        //     console.log(res);
        // }).catch(err => {
        //     console.log(err);
        // })
    ...
    const handleAddToHeart = () => {
        ...
        //     console.log(err);
        // })
        axios.get(serverPort+'/api/promotion/single__promotion__get',{headers:{promotion__name}}).then(res =>{
            console.log(res);
        }).catch(err => {
            console.log(err);
        })
