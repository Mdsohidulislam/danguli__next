...
import CartTwo from "../../SelectedCarts/CartTwo/CartTwo";
  ...
  render() {
    ...
    return (
        <div className="best__rated__container"> 
            <TopRowHeaderTitleWithBorder infos={{ bgc: '#f0f2f5',  brc: '#761bcc', brr: 10 , title: 'Recently Added', display: 'none', strkbg: '#761bcc'}}/>
      {/*  */}
            <div className="brand__slider__container__with__next__prev"> 
                <div className="header__slider__slider__container">
                    <Slider ref={c => (this.slider = c)} {...settings}>  
                    {
                      this.products.map((info, index) => <CartTwo key={index} infos={info} count={index}/>)
                    } 
                    </Slider>
                </div>
