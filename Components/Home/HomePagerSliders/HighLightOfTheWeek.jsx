...
export default class HighLightOfTheWeek extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
        <div className="best__rated__container"> 
            <TopRowHeaderTitleWithBorder infos={{ bgc: '#f0f2f5',  brc: '#761bcc', brr: 10 , title: 'High light of the week', display: 'none', strkbg: '#761bcc'}}/>
