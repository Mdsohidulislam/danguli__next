...
export default class InnovatedGadget extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
        <div className="best__rated__container"> 
                    <TopRowHeaderTitleWithBorder infos={{ bgc: '#f0f2f5',  brc: '#761bcc', brr: 10 , title: 'Innovated Gadget', display: 'none', strkbg: '#761bcc'}}/>
