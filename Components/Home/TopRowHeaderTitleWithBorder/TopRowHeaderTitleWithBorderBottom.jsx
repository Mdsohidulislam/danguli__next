...
const TopRowHeaderTitleWitBorderBottom = ({infos}) => {
    // let infos = { bgc: '#f0f2f5',  brc: '#761bcc', brr: 10 }
    return (
        <div className='TopRowHeaderTitleWithBorder__container__border__bottom'>
...
export default TopRowHeaderTitleWitBorderBottom;