...
const HighLOTW = () => {
    ...
    useEffect(()=>{
        axios.get(serverPort+'/api/promotion/singlePromotionGet',{headers:{promotion: 'high__light__of__the__week'.replace(/__/g,'underScore')}})
        .then(res => { 
    ...
    return (
        <div>
            {
                products.length ? <UpgradeYourGamingStation product={{products,promotion__name, name: 'High light of the week'}}/> : ''
            }
        </div>
    );
};

export default  HighLOTW;