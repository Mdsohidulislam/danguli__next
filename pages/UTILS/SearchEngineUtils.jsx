...
// SearchEngine.allSubCategoryFilter = (sub, parent,  array) => {
//     let sortedArray = [];
//     let collections = [];
//     let filteredBrandProductQuantity = []
//     let productId = [];
...
// SearchEngine.allItemsFinder = ( key, array ) => {
//     let sortedArray = [];
//     let collections = [];
//     let filteredBrandProductQuantity = [];
//     let productId = [];
...
//     array.forEach((info, index) => {
//         if(info.subCategory.toLowerCase() === key.toLowerCase()  || info.parent.toLowerCase() === key.toLowerCase() ){
//             sortedArray.push(info)
//             if(collections.indexOf(info.collection.toLowerCase()) !== -1){
//                 let index = collections.indexOf(info.collection.toLowerCase()); 
//                 let {count} = filteredBrandProductQuantity[index];
