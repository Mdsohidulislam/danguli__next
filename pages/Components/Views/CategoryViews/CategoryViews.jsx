...
const SingleCategoryView = ({infos}) => {
    ...
    const handleGetCurrentPageAllProduct = () => { 
        setShowCount(()=> 40);
        setViewCount(()=> 40);
        axios.get(serverPort+'/api/product/getSingleCategory',{headers:{category: name}}).then(res => { 
                ...
                <div style={{overflow:"hidden"}}>  
                    ...
                    <div className='view__all__or__category___product__container'>  
                        <div className='child__top__links__upper__cover'>
                            <SingleCategoryTopLinks infos={{ name}}/> 
                        </div>
